...
/**
 * Servlet implementation class SetRoot
 */
@WebServlet("/api/SetRoot")
public class SetRoot extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Bean bean = new Bean();
			bean.put("no", param.getString("no"));
			bean.put("is_root", param.getString("is_root"));
			Model model = new Model();
			model.updateBean("user", "no", bean);
